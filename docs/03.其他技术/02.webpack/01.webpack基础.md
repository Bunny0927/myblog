...
Webpack4以后的版本支持零配置的方式直接启动打包

整个过程按照约定将src/index.js作为打包入口

最终打包结果存放到dist/main.js中

对一个普通项目，使用命令初始化，生成package.json：
```bash
npm init --yes
```
安装webpack：
...
![600](https://cdn.jsdelivr.net/gh/liuzw-cyy/images/img/bundle.png)
...
[博文：webpack看这一篇就够了](https://blog.csdn.net/weixin_46862327/article/details/125364534)

[视频：Webpack原理与实战，手把手教你如何使用webpack打包项目](https://www.bilibili.com/video/BV1t5411A7zi)
